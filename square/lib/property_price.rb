class PropertyPrice
  ...
  def self.getonly(addr1)
	url = "http://free-ec2.scraperwiki.com/dar3zry/d6fe1a84b5f4474/sql/?q=select%20%0A%09date%2C%0A%20%20%20%20lat%2C%0A%20%20%20%20lon%2C%0A%09address1%2C%0A%20%20%20%20address2%2C%0A%20%20%20%20address3%2C%0A%09price%0Afrom%20swdata%0Awhere%20address1%20like%20%27%25#{addr1}%25%27%0Aorder%20by%20id%20asc"    
    response = HTTParty.get(url)
    body = JSON.parse(response.body)
    return body
  end
